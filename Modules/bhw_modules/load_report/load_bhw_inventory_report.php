...
<style>
    /* Removes padding from the parent 'card-body' */
    .card-body {
        padding: 0 !important; 
    }
    /* Removes padding from the main container if needed */
    .container-fluid {
        padding-left: 0 !important;
        padding-right: 0 !important;
    }
    /* Ensures this page takes 100% width */
    .table-wrapper {
        border: none !important; /* Removes inner border to blend better */
    }
</style>
<div class="w-100 p-3"> <div class="d-flex align-items-center justify-content-between mb-2 w-100">
    ...
    <div class="table-wrapper w-100 m-0 p-0">
        <?php if ($result && $result->num_rows > 0): ?>
            <table class="table report-table w-100 mb-0 table-striped">
                <thead>
                    <tr class="bg-light">
                ...
                <tbody>
                    ...
                    <?php 
                        ...
                        // Optional: Highlight row if empty
    ...
    <div class="row mt-4 text-center w-100 mx-0" style="page-break-inside: avoid;">
        <div class="col-4">
