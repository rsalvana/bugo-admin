...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><?php echo htmlspecialchars($roleName ?? 'Captain'); ?> Dashboard</h1>
...
async function loadDashboard() {
    try {
        ...
        // NOTE: Make sure 'dashboard/admin_dashboard.php' is accessible to the Captain role too
        // If not, point this URL to the correct Captain API endpoint
