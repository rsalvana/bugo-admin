...
<form method="GET" action="index_barangay_secretary.php" class="row g-2 mb-3">
...
<div class="col-md-1">
  ...
  <div class="col-md-2">
    <?php $resbaseUrl = enc_brgysec('resident_info'); ?>
...
<!-- Pagination (windowed) -->
<?php
$baseUrl   = enc_brgysec('resident_info'); // ✅ keep this
