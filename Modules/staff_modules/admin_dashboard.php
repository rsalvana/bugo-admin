...
<head>
    ...
    <style>
        ...
        /* Recent PB activity table tweaks */
        #recentPBActivity tr td { white-space: nowrap; }
    </style>
</head>
<body>
<div class="container my-5">
    ...
    <!-- Barangay Highlights (hidden for now)
    ...
    <!-- Recent Activity (Punong Barangay) -->
...
<script>
// Escape + render helper for Recent Activity
...
fetch('dashboard/admin_dashboard.php')
  ...
  .then(data => {
    ...
    // Render Recent Activity from backend payload
