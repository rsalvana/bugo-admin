<?php
// components/employee_modal/show_esignature.php (PB only; requires ?employee_id=##)
...
try {
    ...
    $sql = "
        ...
        WHERE el.employee_id = ?
          AND TRIM(LOWER(er.Role_Name)) = 'punong barangay'
...
} catch (Throwable $e) { error_log('show_esignature exception: '.$e->getMessage()); out_blank(); }
