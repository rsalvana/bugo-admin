...
<head>
    ...
    <style>
        ...
        @media (max-width: 992px) {
            ...
            /* When BODY has 'sb-sidenav-toggled' class, show sidebar */
...
<body class="sb-nav-fixed">
        ...
        <ul class="navbar-nav ms-auto me-3 me-lg-4 align-items-center">
            ...
            <li class="nav-item dropdown me-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow border-0" aria-labelledby="notifDropdown" style="width: 320px; max-height: 400px; overflow-y: auto;">
                    <li><h6 class="dropdown-header text-uppercase fw-bold text-success px-3 py-2">Ready for Delivery</h6></li>
                    ...
                    <li><hr class="dropdown-divider my-0"></li>
                    <li>
                        <a class="dropdown-item text-center small fw-bold text-success py-2 bg-light" href="index_Liason.php?page=<?= urlencode(encrypt('med_request')) ?>">
                            View Delivery List
                        </a>
                    </li>
                </ul>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link <?php echo ($page === 'liason_dashboard') ? '' : 'collapsed'; ?>" href="index_Liason.php?page=<?php echo urlencode(encrypt('liason_dashboard')); ?>">
            ...
            <main>
                ...
                <main id="main" class="main">
                    <section class="section"> 
                        ...
                        $decryptedPage = 'liason_dashboard'; 
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (sidebarToggle) {
            sidebarToggle.addEventListener('click', function(event) {
                ...
                // Toggle the class on BODY that controls the sidebar in the CSS I wrote
    ...
    // --- LIASON NOTIFICATION SYSTEM (Triggers on APPROVED) ---
    document.addEventListener('DOMContentLoaded', function() {
        let lastCount = 0; 
        ...
        function checkLiasonNotifications() {
            ...
            .then(data => {
                ...
                // 1. Update Badge based on APPROVED requests
                if (currentCount > 0) {
                    badge.innerText = currentCount > 99 ? '99+' : currentCount;
                    badge.style.display = 'inline-block';
                    badge.classList.add('badge-pulse'); 

                    // Toast Alert specifically for Liason
                    if (currentCount > lastCount && lastCount !== 0) {
                        const Toast = Swal.mixin({
                            toast: true, position: 'top-end', showConfirmButton: false, timer: 3000, timerProgressBar: true
                        });
                        Toast.fire({ icon: 'success', title: 'New Medicine Ready for Delivery!' });
                    }
                } else {
                ...
                if (data.data.length > 0) {
                    ...
                    data.data.forEach(item => {
                        html += `
                            <li>
                                <a class="dropdown-item py-2 border-bottom" href="index_Liason.php?page=<?= urlencode(encrypt('med_request')) ?>">
                                    <div class="d-flex w-100 justify-content-between align-items-center">
                                        <div>
                                            <div class="small fw-bold text-dark"><i class="bi bi-box-seam text-success"></i> ${item.resident_name}</div>
                                            <div class="small text-muted" style="font-size:0.7rem;">${item.address}</div>
                                        </div>
                                        <small class="text-secondary" style="font-size: 0.7rem;">Approved</small>
                                    </div>
                                </a>
                            </li>
                        `;
                    ...
                    list.innerHTML = '<li class="dropdown-item text-center small text-muted py-3">No pending deliveries</li>';
                }
            })
