...
if ($stmt) {
    ...
    if (strpos($roleNameLower, 'barangay secretary') === false) {
...
<html lang="en">
    <head>
        ...
        <title>LGU BUGO - Barangay Secretary</title>
        <link rel="stylesheet" href="css/form.css">
        <!-- <link rel="stylesheet" href="assets/css/form_print.css"> -->
        <link href="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/style.min.css" rel="stylesheet" />
        <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
        
        <!-- REMOVED Bootstrap 4 JS and Popper.js, as they conflict with Bootstrap 5 -->
        <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/2.11.6/umd/popper.min.js"></script> -->
        <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script> -->
        
        <link href="css/styles.css" rel="stylesheet" />
        
        <!-- REMOVED Bootstrap 4 CSS, as it conflicts with Bootstrap 5 -->
        <!-- <link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet"> -->
        
        <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" rel="stylesheet">
        <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
        <!-- <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> --> <!-- Already loaded above -->
        <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet">
        
        <!-- Using one consistent version of Bootstrap 5 -->
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
        
        <!-- ADDED: The missing responsive.css file from your 'captain' example -->
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
        ...
        <!-- ADDED: Hard mobile overrides from 'captain' to handle the off-canvas sidenav -->
        <style>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <!-- Encrypted Sidebar Links -->
                                <a class="nav-link <?php echo ($page === 'admin_dashboard') ? '' : 'collapsed'; ?>" href="index_barangay_secretary.php?page=<?php echo urlencode(encrypt('admin_dashboard')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div> Dashboard
                                </a>

                                <a class="nav-link <?php echo ($page === 'resident_info') ? '' : 'collapsed'; ?>" href="index_barangay_secretary.php?page=<?php echo urlencode(encrypt('resident_info')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-users"></i></div> Resident List
                                </a>

                                <a class="nav-link <?php echo ($page === 'feedbacks') ? '' : 'collapsed'; ?>" href="index_barangay_secretary.php?page=<?php echo urlencode(encrypt('feedbacks')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-comment-dots"></i></div> Feedback
                                </a>
                                <a class="nav-link <?php echo ($page === 'view_appointments') ? '' : 'collapsed'; ?>" href="index_barangay_secretary.php?page=<?php echo urlencode(encrypt('view_appointments')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-calendar-check"></i></div> View Appointments
                                </a>                               
                                 <a class="nav-link <?php echo ($page === 'reports') ? '' : 'collapsed'; ?>" href="index_barangay_secretary.php?page=<?php echo urlencode(encrypt('reports')); ?>">
...
switch ($decryptedPage) {
            case 'admin_dashboard':
                include 'Modules/secretary_modules/admin_dashboard.php';
              break;
            case 'feedbacks':
                include 'Modules/secretary_modules/Feedbacks.php';
              break;
            case 'reports':
                include 'Modules/secretary_modules/reports.php';
              break;
              case 'resident_info':
                include 'Modules/secretary_modules/resident_info.php';
              break;
              case 'view_appointments':
                include 'Modules/secretary_modules/view_appointments.php';
              break;               
              case 'families':
...
case 'settings':
  ...
  break;
  default:
    echo "<div class='alert alert-danger'>Invalid or missing page: T<code>" . htmlspecialchars($decryptedPage) . "</code></div>";
     break;
}
?>
        ...
        <!-- REMOVED: Conflicting Bootstrap 5.2.3 bundle. The 5.3.0 bundle is already loaded in the <head> -->
...
function confirmLogout() {
    ...
    return false;
        ...
        <!-- ADDED: Mobile sidebar + auto-wrap wide tables script from 'captain' -->
        <script>
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (btn && nav) {
    ...
    document.addEventListener('click', function (e) {
      if (window.matchMedia('(max-width: 992px)').matches) {
        // Check if the click is outside the nav and also not the toggle button itself
  ...
  // This finds tables inside your main content area
  const main = document.querySelector('main .section, main');
  if (main) {
    main.querySelectorAll('table').forEach(t => {
      // If it's not already wrapped in a .table-responsive
      if (!t.closest('.table-responsive')) {
        const wrap = document.createElement('div');
        wrap.className = 'table-responsive';
        t.parentNode.insertBefore(wrap, t); // Put the wrapper where the table was
        wrap.appendChild(t); // Move the table inside the wrapper
      }
    });
  }
});
