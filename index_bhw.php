                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link <?php echo ($page === 'bhw_dashboard') ? '' : 'collapsed'; ?>" href="index_bhw.php?page=<?php echo urlencode(encrypt('admin_dashboard')); ?>">
                             ...
                             <a class="nav-link <?php echo ($page === 'med_request') ? '' : 'collapsed'; ?>" href="index_bhw.php?page=<?php echo urlencode(encrypt('resident_info')); ?>">
...
switch ($decryptedPage) {
            case 'bhw_dashboard':
              ...
              break;
            case 'med_request':
                include 'Modules/bhw_module/med_request.php';
              break;
            case 'bhw_report':
                include 'Modules/bhw_module/bhw_report.php';
              break;
              case 'med_inventory':
                include 'Modules/bhw_module/med_inventory.php';
              break;
    case 'profile':
