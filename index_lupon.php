...
if ($stmt) {
    ...
    if (strpos($roleNameLower, 'lupon') === false) {
...
<html lang="en">
    <head>
        ...
        <title>LGU BUGO - Lupong Tagapamayapa</title>

        <!-- === FIX #1: Cleaned up CSS includes to match 'captain' === -->
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" rel="stylesheet">
        ...
        <!-- === FIX #3: Added Mobile Sidebar CSS (from captain) === -->
        <style>
         ...
         @media (max-width: 992px) {
           ...
           /* This overrides any 'position: sticky' from simple-datatables or other CSS */
           .dataTable-container thead,
           .table-responsive thead,
           .dataTable-wrapper .dataTable-table > thead {
             position: static !important; /* Forces it to scroll with the table */
             z-index: auto !important;
           }

           /* === FIX #9: Force tables in responsive wrappers to NOT wrap === */
           /* This makes the table wide, forcing the .table-responsive to scroll */
           ...
           /* This overrides 'display: block' or 'display: grid' from other plugins */
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link <?php echo ($page === 'admin_dashboard') ? '' : 'collapsed'; ?>" href="index_lupon.php?page=<?php echo urlencode(encrypt('admin_dashboard')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div> Dashboard
                                </a>
                             <a class="nav-link <?php echo ($page === 'resident_info') ? '' : 'collapsed'; ?>" href="index_lupon.php?page=<?php echo urlencode(encrypt('resident_info')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-users"></i></div> Resident List
                                </a>
                              <a class="nav-link <?php echo ($page === 'case_list') ? '' : 'collapsed'; ?>" href="index_lupon.php?page=<?php echo urlencode(encrypt('case_list')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-gavel"></i></div> Case List
                                </a>
                                 <a class="nav-link <?php echo ($page === 'reports') ? '' : 'collapsed'; ?>" href="index_lupon.php?page=<?php echo urlencode(encrypt('reports')); ?>">
...
switch ($decryptedPage) {
            case 'admin_dashboard':
                include 'Modules/lupon_modules/admin_dashboard.php';
              break;
            case 'case_list':
                include 'Modules/lupon_modules/case_list.php';
              break;
            case 'resident_info':
                include 'Modules/lupon_modules/resident_info.php';
              break;
             case 'reports':
                include 'Modules/lupon_modules/reports.php';
              break;
...
function confirmLogout() {
    ...
    return false;
        ...
        <!-- === FIX #6: REMOVED REDUNDANT SCRIPT === -->
        <!-- The simple script from the previous turn has been removed -->
