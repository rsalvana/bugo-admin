...
// ... [ALL YOUR PHP CODE REMAINS EXACTLY THE SAME] ...
// ... [NO CHANGES TO YOUR DATABASE QUERIES OR SESSION LOGIC] ...
...
if ($stmt) {
    ...
    if (strpos($roleNameLower, 'multimedia') === false) {
...
<html lang="en">
    <head>
        ...
        <title>LGU BUGO - Barangay Multimedia</title>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link <?php echo ($page === 'admin_dashboard') ? '' : 'collapsed'; ?>" href="index_multimedia.php?page=<?php echo urlencode(encrypt('admin_dashboard')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div> Dashboard
                                </a>
                                <a class="nav-link <?php echo ($page === 'event_list') ? '' : 'collapsed'; ?>" href="index_multimedia.php?page=<?php echo urlencode(encrypt('event_list')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-calendar"></i></div> Event List
                                </a>
                        </div>
                    </div>
                            ...
                            <section class="section"> 
                                ...
                                switch ($decryptedPage) {
                                    case 'admin_dashboard':
                                        include 'Modules/multimedia_modules/admin_dashboard.php';
                                        break;
                                    case 'event_list':
                                        include 'Modules/multimedia_modules/event_list.php';
                                        break;
