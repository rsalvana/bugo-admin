...
if ($stmt) {
    ...
    if (strpos($roleNameLower, 'revenue') === false) {
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <!-- Encrypted Sidebar Links -->
                                <a class="nav-link <?php echo ($page === 'admin_dashboard') ? '' : 'collapsed'; ?>" href="index_revenue_staff.php?page=<?php echo urlencode(encrypt('admin_dashboard')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div> Dashboard
                                </a>

                                <a class="nav-link <?php echo ($page === 'urgent_request') ? '' : 'collapsed'; ?>" href="index_revenue_staff.php?page=<?php echo urlencode(encrypt('urgent_request')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-exclamation-circle"></i></div> On-Site Request
                                </a>

                                <a class="nav-link <?php echo ($page === 'view_appointments') ? '' : 'collapsed'; ?>" href="index_revenue_staff.php?page=<?php echo urlencode(encrypt('view_appointments')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-calendar-check"></i></div> View Appointments
                                </a>
                                <a class="nav-link <?php echo ($page === 'reports') ? '' : 'collapsed'; ?>" href="index_revenue_staff.php?page=<?php echo urlencode(encrypt('reports')); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-calendar-check"></i></div> Report
                                </a>                                
                        </div>
                    </div>
...
switch ($decryptedPage) {
            case 'admin_dashboard':
                include 'Modules/revenue_modules/admin_dashboard.php';
              break;
            case 'view_appointments':
                include 'Modules/revenue_modules/view_appointments.php';
              break;
            case 'urgent_request':
                include 'Modules/revenue_modules/urgent_request.php';
              break;
...
case 'settings':
    ...
    break;
        case 'reports':
    include 'Modules/revenue_modules/reports.php';
    break;    
